...
class BasePyWindow(PyWindow):

	def __init__(self,**params):
		super(BasePyWindow,self).__init__()
		self.params = params
...
class PyAnalytic2PCF(BasePyWindow):
...
class PyAnalytic3PCF(BasePyWindow):
...
class PyAnalytic4PCF(BasePyWindow):
